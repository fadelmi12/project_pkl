...
<script type="text/javascript">
	function ambildata(){
		...
		addrow(tgl_transaksi,jns_transaksi,nama_supplier,jumlah,nama_barang,kondisi,pengirim,penerima);
	}
	var i = 0;
	function addrow(tgl_transaksi,jns_transaksi,nama_supplier,jumlah,nama_barang,kondisi,pengirim,penerima){
		i++;
		$('#TabelDinamis').append('<tr id="row'+i+'"><td><a name="tgl_transaksi[]" id="tgl_transaksi">'+tgl_transaksi+'</a></td><td style="display:none;"><a name="jns_transaksi[]" id="jns_transaksi">'+jns_transaksi+'</a></td><td><a name="nama_supplier[]" id="nama_supplier">'+nama_supplier+'</a></td><td style="display:none;"><a name="jumlah[]" id="jumlah">'+jumlah+'</a></td><td><a name="nama_barang[]" id="nama_barang">'+nama_barang+'</a></td><td style="display:none;"><a name="kondisi[]" id="kondisi">'+kondisi+'</a></td><td style="display:none;"><a name="pengirim[]" id="pengirim">'+pengirim+'</a></td><td style="display:none;"><a name="penerima[]" id="penerima">'+penerima+'</a></td><td><button type="button" id="'+i+'" class="btn btn-danger btn-small remove_row">&times;</button></td></tr>');
	};
