            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-dark">Buat Pengajuan Barang Retur</h5>
                    </div>
                    <!-- Breadcrumb -->
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="index.html">Pengajuan</a></li>
                            <li><a href="/brgretur"><span>Pengajuan Barang Retur</span></a></li>
                            <li class="active"><span>Buat Pengajuan Barang Baru</span></li>
                        </ol>
                    </div>
                    <!-- /Breadcrumb -->
                </div>
                            ...
                            <div class="panel-wrapper collapse in ">
                                <div class="panel-body">
                                    <div class="form-wrap mt-3">
                                        <form action="{{ url('addretur2') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
