            ...
            <form action="{{ url('Confirm') }}/{{ $data_baru->id_pengajuan }}" class="modal-body" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="hidden" value="{{ $data_baru->noPO }}" name="po">
                        @endif
...
<!------------------------------------------------------ confirm retur ----------------------------------------------------------------------------->
<div class="modal fade" id="confirmRetur{{ $data_baru->id_pengajuan }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
