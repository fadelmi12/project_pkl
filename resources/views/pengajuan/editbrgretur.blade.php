<div class="modal fade" id="editbrgretur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                        <label class="control-label mb-10 text-left">No PO</label>
                    ...
                    <div class="form-group">
                        <label class="control-label mb-10 text-left">Tanggal Pengajuan</label>
