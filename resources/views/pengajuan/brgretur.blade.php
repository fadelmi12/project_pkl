                                            ...
                                            <table id="myTable1" class="table table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="pengajuan/editRetur/{{ $data_baru->id_pengajuan }}" class="btn btn-success btn-icon-anim btn-square"><i class="fa fa-edit"></i></button>
                                                            <a class="btn btn-danger btn-icon-anim btn-square" data-toggle="modal" data-target="#hapusretur" onclick="setEditForm( {{url('deleteretur')}}/{{ $data_baru->id_pengajuan }})"><i class="fa fa-trash"></i></></button>
                                                    </tr>
                        ...
                        <div class="panel-body">
                            <div class="table-wrap">
                                <div class="">
                                    ...
                                    @include('pengajuan.hapusbrgretur')
>>>>>>> 7a0c1aaf28c3a46598c0a745190fb52f94aa5645
                                </div>
                            </div>
                        </div>
                    </div>
